...
const Banner = () => {
  return (
    <section>
      <div className="pt-[5rem]  text-[#ffffff] md:pt-[7rem] lg:pt-[8.0625rem] lg:max-w-[69.375rem] lg:mx-auto">
        <div className="flex flex-col gap-[1.125rem] lg:flex-row lg:px-8 lg:gap-[1.875rem]">
          ...
          <div className="px-8 lg:w-[27.8125rem] lg:px-0 lg:grid lg:gap-[4.9375rem]">
